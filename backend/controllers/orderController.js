...
const placeOrder = async (req, res) => {
    ...
    const frontend_url = "https://tomato-food-delivery-e98d.onrender.com"
    ...
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            mode:'payment',
            success_url:`https://tomato-food-delivery-e98d.onrender.com/verify?success=true&orderId=${newOrder._id}`,
            cancel_url:`https://tomato-food-delivery-e98d.onrender.com/verify?success=false&orderId=${newOrder._id}` 
        })
